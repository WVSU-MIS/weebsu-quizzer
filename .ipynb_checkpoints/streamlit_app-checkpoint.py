...
def app():
    ...
    st.header("A proof of concept of using generative AI for specialized tasks.")
    ...
    input_topic = st.text_area('Input the topic of the quiz:', topic, height=1)
    ...
    input_competencies = st.text_area('Input the competencies:', competencies, height=5)   
